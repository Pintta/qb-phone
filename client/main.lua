...
local function OpenPhone()
    QBCore.Functions.TriggerCallback('qb-phone:server:HasPhone', function(HasPhone)
        if HasPhone then
            ...
            SetNuiFocusKeepInput(true) -- When you use the phone, you can also move same time. 
            SendNUIMessage({
                action = 'open',
...
RegisterNetEvent('qb-phone:client:PinttaHC', function()
...
RegisterNUICallback('TakePhoto', function(_, cb)
    ...
    while takePhoto do
        ...
        elseif IsControlJustPressed(1, 176) then -- TAKE.. PIC
            exports['screenshot-basic']:requestScreenshotUpload(Config.CPDH, 'files[]', function(data)
